create table if not exists Artist(id serial primary key, username text, name text, password text, avatar text, age int, followerCount int, followers text, description text, location text, date text, active boolean, likeCount int);
...
insert into Artist(username, name, password, avatar, followers, followerCount, description, location, date, active, likeCount) VALUES('burtonBurton', 'Burton Burton', '$2a$10$VdPNYKHKomEf7aQhspANxOS4Y2vlAbgiOLcn5xWwaL2/NOOcETh5e$2a$10$nctfLFOnJLHkMLz1G3xYWead9Imsx4d8ji8iZNm4An7aWtqoRNiku', 'avatars/sampleAvatar.jpg','jonnyBoy', 1, 'Professional drummer and musician', 'Los Angelos, California', '20110404', true, 13008);
insert into Artist(username, name, password, avatar, age, followers, followerCount, description, date, active, likeCount) VALUES('lenny', 'Lenny Shmow', '$2a$10$VdPNYKHKomEf7aQhspANxOS4Y2vlAbgiOLcn5xWwaL2/NOOcETh5e$2a$10$nctfLFOnJLHkMLz1G3xYWead9Imsx4d8ji8iZNm4An7aWtqoRNiku', 'avatars/sampleAvatar.jpg', 21, 'rodney, robgrocowski', 2, 'Musician', '20160425', true, 80);
insert into Artist(username, name, password, avatar, age, followers, followerCount, description, date, active, likeCount) VALUES('bobclob', 'Bob Clobnernazki', '$2a$10$VdPNYKHKomEf7aQhspANxOS4Y2vlAbgiOLcn5xWwaL2/NOOcETh5e$2a$10$nctfLFOnJLHkMLz1G3xYWead9Imsx4d8ji8iZNm4An7aWtqoRNiku', 'avatars/sampleAvatar.jpg', 28, '', 0, 'Musician', '20160425', false, 10);
